...
def feature_engineering(
        input_path: str | None = 'artifacts/data/simulated_transactions_v42_0.csv',
        output_path: str | None = 'artifacts/features/fraud_features_v42_0.csv',
        save: bool | None = True
        ):
    ...
    if save:
        if output_path is None:
            ...
            output_path = output_dir / f"fraud_features_v42_0.csv"
        else:
